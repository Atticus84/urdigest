        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <div className="flex items-start">
              <input
                ...
                type="checkbox"
                required
                className="mt-1 h-4 w-4 text-instagram-pink focus:ring-instagram-pink border-gray-300 rounded"
              />
              <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
                I agree to the{' '}
                <Link href="/terms" className="text-instagram-pink hover:underline">
                  Terms of Service
                </Link>
                {' '}and{' '}
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="text-instagram-pink font-semibold hover:underline">
                Log in
              </Link>
            </p>
          </div>
